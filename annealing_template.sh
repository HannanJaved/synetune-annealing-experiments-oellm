...
WANDB_EXP_NAME="synetune-initial-runs6"
...
# python /leonardo_work/AIFAC_L01_028/hmahadik/checkpoint-conversion/consolidated_conversion_workflow.py \
...
######################################################################################
# # --- Submit the Test Job with a Dependency ---
# sbatch --dependency=afterok:${JOB_IDS} <<EOF
# #!/bin/bash
# #SBATCH --job-name=DependencyTest
# #SBATCH --output=/leonardo/home/userexternal/hmahadik/logs/synetune/TEST/dependency.out
# #SBATCH --error=/leonardo/home/userexternal/hmahadik/logs/synetune/TEST/dependency.err
# #SBATCH --nodes=1
# #SBATCH --ntasks=1
...
# echo "✅ Dependency Test Started: $(date)"
# echo "--------------------------------------------------------"
# echo "This test job is running on node: $(hostname)"
# echo "It successfully waited for the following conversion jobs to complete: ${JOB_IDS}"
# echo "This confirms the --dependency=afterok logic is working."
# echo "Sleeping for 10 seconds to simulate a small task..."
# sleep 10
# echo "--------------------------------------------------------"
# echo "✅ Dependency Test Finished: $(date)"

# EOF

# echo "Test job submitted. It will run after all conversions are complete."
######################################################################################